...
public class Controleur extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action == null) {
            ...
            rd = request.getRequestDispatcher("connexion1.jsp");
            ...
            String type = request.getParameter("typeStatation");
...
//</div
            ...
            String nomLocalisation = request.getParameter("nomLocalisation");
            String typeLocalisation = request.getParameter("typeLocalisation");
          ...
          System.out.println(nom);
           ...
           //http://localhost:8084/Memoire2019/Controleur?action=mdf&id=20
            ...
            try {
                mi.envoiMail(email, log, pas,url);
            } catch (Exception ex) {
...
//            getServletContext().setAttribute("profil", us.getProfil());
          ...
          //  mi.modifierUser(idUser, nom, prenom,login,email,passe,adresse,tel);
            User User = mi.listeCompteAbonne(login,passe);
//            User us=new User();
            HttpSession session = request.getSession();
            session.setAttribute("User", User);

            if (tel.length() == 9) {
                if (!mi.selectMDP(login)) {
//                    request.setAttribute("passe", us.getPasse());
//                    request.setAttribute("idUser", us.getIdUser());
//                    request.setAttribute("prenom", us.getPrenom());
//                    request.setAttribute("nom", us.getNom());
...
//                request.setAttribute("email", us.getEmail());
            ...
            //  regarder=vu&recherch=prenom&rechRe=battoush
            ...
            if (option == null || saisie == null ) {
                getServletContext().setAttribute("listerAbonne", mi.ListerUserAbonne());
                rd = request.getRequestDispatcher("listeAbonne.jsp");
            } else if (option.equals("prenom")) {
                String valsaisie1 = request.getParameter("saisie");
                System.out.println(valsaisie1);
                request.setAttribute("listerAbonne", mi.ListerAbonne(saisie));
                rd = request.getRequestDispatcher("listeAbonne.jsp");
            } else if (option.equals("nom")) {                
                request.setAttribute("listerAbonne", mi.ListerAbonne1(saisie));
                rd = request.getRequestDispatcher("listeAbonne.jsp");
            } else if (option.equals("adresse")) {
                request.setAttribute("listerAbonne", mi.ListerAbonne2(saisie));
                rd = request.getRequestDispatcher("listeAbonne.jsp");
            }
            else if (option.equals("zone")) {
                request.setAttribute("listerAbonne", mi.ListeAbonne4(saisie));
                rd = request.getRequestDispatcher("listeAbonne.jsp");
            }
...
//            String nomBat=request.getParameter("rechBat");
           ...
           String nomBat=request.getParameter("rechBat");
           System.out.println(nomBat);
         request.setAttribute("listerBatiment", mi.RechercheBatiment(nomBat));
           rd = request.getRequestDispatcher("listeBatiment.jsp");
        }
...
/////// Reseau/////////////
        ...
        else if (action.equals("RechReseau")) {
        
            String nomR=request.getParameter("recReseau");
...
//       }
            ...
            rd = request.getRequestDispatcher("modifierObjet.jsp");
             ...
             int idOb = Integer.parseInt(request.getParameter("idObject"));
...
//             System.out.println("id="+idOb2);
            ...
            request.setAttribute("listeObjetUser", mi.listeObjetUser(id));
